 ...
 */
int yuvproc::packedyuv422_to_grey8(uint8_t *dest, const uint8_t *data,
...
int yuvproc::luminance_of_packedyuv422(uint8_t *dest, struct framedata *frame)
{
    return packedyuv422_to_grey8(dest, frame->base, frame->pixfmt->width,
                frame->pixfmt->height, frame->pixfmt->pixelformat);
}

void yuvproc::convert_yuyv_to_grey8(const uint8_t *src, uint8_t *dest,
...
void yuvproc::convert_grey8_to_rgb24(const uint8_t *src, uint8_t *dest,
            int width, int height)
{
    int i;
...
void yuvproc::convert_yuyv_to_rgb24(const uint8_t *src, uint8_t *dest,
...
void yuvproc::convert_yuyv_to_rgb32(const uint8_t *src, uint8_t *dest,
        int width, int height, int stride)
{
    uint32_t *d;
    int mpixsperline, i;
